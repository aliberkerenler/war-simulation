...
* **Saldırı/Savunma Gücü:** Birlik başına saldırı/savunma gücü ile birlik sayısının çarpımı ile hesaplanır.
* **Net Hasar:**
    $$Net\ Hasar = Saldırı\ Gücü \times (1 - \frac{Savunma\ Gücü}{Karşı\ Birliğin\ Saldırı\ Gücü})$$
...
* **Birlik Kayıpları:** Bir birliğin birim başına sağlık durumu sıfıra ulaştığında, o birlik savaştan çekilir.

### 🖥️ Görselleştirme ve Çıktı
* **Raylib Görselleştirme:** Savaş öncesi ve sonrası durumlar $20\times20$ boyutunda bir ızgarada görselleştirilir.
* **Sağlık Barları:** Birliklerin sağlıkları renkli barlarla yansıtılır (Yeşil: %100-%50, Sarı: %50-%20, Kırmızı: %20 ve altı).
* **Detaylı Loglama:** Savaşın her adımı, tüm hesaplamalarla birlikte **`savas_sim.txt`** dosyasına detaylı olarak yazdırılır.
